...
const Hero = () => {
    ...
    return (
        <div className='text-center md:h-screen pt-8' style={{marginTop: `${navHeight}px`}}>
            ...
            <button className=' mb-12 w-44 text-xl hover:text-gray-500 text-left font-semibold text-orange-500'>Request a demo <BsArrowRight className='inline-block' /> </button>
        </div>
    )
}
