...
const Hero = () => {
    return (
        <div className='text-center '>
            ...
            <p className='text-center w-full text-xl mt-2 font-medium px-3'>Learn where your audience struggle as they navigate your digital business. Pair this understanding of the individual experience with powerful quantitative insights to inform your digital decisions.</p>
            <div className='relative mt-8'>
                <button className='bg-gray-800 z-20 p-4 w-40 tracking-wide text-white font-bold'>TRY FOR FREE</button>
                <div className=' absolute top-4 left-52 -z-10 bg-orange-500 h-14 mx-auto w-40 p-4'></div>
            </div>
